    ...
    <div class="pages__content">
      ...
      <main class="main__content">
        ...
        <div class="cls__content">
          ...
          <div class="add__cls">
            <form action="tags.php" method="post" class="form__content">
              <div class="form__input">
                <label for="tag__name">Tag Name</label>
                <input type="text" name="tag__name" placeholder="Tag name" />
              </div>
          ...
          <ul class="cls__list">
            <?php 
              ...
              foreach($tags as $tag): ?>
                <li class="cls__card">
                  <div class="cls__name">
                    <span><span>#</span><span><?= $tag["tagName"] ?></span></span>
                  </div>
                  <div class="cls__management">
                    <span>
                      <a href="./updateTag.php?id=<?= $tag["tagId"] ?>">
